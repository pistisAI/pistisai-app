...
if [[ ! -f "$FAKE_DIST_DIR/cloudtolocalllm-10.1.200-x86_64.AppImage" ]]; then
  echo "Expected AppImage at $FAKE_DIST_DIR/cloudtolocalllm-10.1.200-x86_64.AppImage" >&2
  cat /tmp/test_build_all_packages_tmpdir_spaces.log >&2
  exit 1
fi

if [[ ! -f "$FAKE_DIST_DIR/cloudtolocalllm-10.1.200-x86_64.AppImage.sha256" ]]; then
  echo "Expected AppImage checksum at $FAKE_DIST_DIR/cloudtolocalllm-10.1.200-x86_64.AppImage.sha256" >&2
  cat /tmp/test_build_all_packages_tmpdir_spaces.log >&2
  exit 1
fi
