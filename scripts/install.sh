...
# curl -L https://github.com/pistisAI/pistisai-app/releases/latest/download/pistisai-${OS} -o "$BIN_DIR/pistisai"
# chmod +x "$BIN_DIR/pistisai"
...
echo "Run 'pistisai' to get started."
